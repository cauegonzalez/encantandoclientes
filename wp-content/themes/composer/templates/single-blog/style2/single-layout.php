...
<div class="newsection single-blog-<?php echo esc_attr( $style ); ?>">
    ...
    <?php
        ...
        $no_image_class = ( ! has_post_thumbnail() || 'no' == $show_feature_section ) ? 'no-feature-image' : '';

    ?>

    <div class="banner <?php echo esc_attr( $no_image_class ); ?>" <?php echo $css; ?>>
	...
	<div class="container">
        ...
        get_template_part( 'templates/single-blog/style2/content', $format ); 
