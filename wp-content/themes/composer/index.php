<?php 
    ...
    get_template_part( 'templates/blog/loop/blog', 'containerstart' );
        ...
        get_template_part( 'templates/blog/loop/blog', 'loopstart' );

            if( have_posts() ) : 

                $composer_blog_page_id = get_option( 'page_for_posts' );
                $content_post = get_post( $composer_blog_page_id );
                ...
                get_template_part( 'templates/blog/post', 'error' );

            endif;


        get_template_part( 'templates/blog/loop/blog', 'loopend' );
    ...
    get_template_part( 'templates/blog/loop/blog', 'containerend' );
