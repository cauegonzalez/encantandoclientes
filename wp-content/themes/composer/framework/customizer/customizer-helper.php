...
function composer_customizer_admin_enqueue() {
	//Load css
	wp_enqueue_style( 'customizer-admin-css', COMPOSER_CUSTOMIZER_URI .'/css/customizer-admin.css', array('kirki-tooltip'), '1.0', 'all' );
}
add_action( 'customize_controls_enqueue_scripts', 'composer_customizer_admin_enqueue' );
