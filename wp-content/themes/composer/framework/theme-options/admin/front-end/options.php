<div class="wrap" id="of_container">
	...
	<div id="of-popup-reset" class="of-save-popup">
		<div class="of-save-reset"><i class="icon-reload"></i> <?php esc_html_e('Options Reset','composer' ); ?></div>
	</div>
				...
				<div id="info_bar">
					...
					<div class="btn-bg">
						<button id="of_save" type="button" class="btn-pri">
							<i class="pix-icon icon-save-disk"></i>
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="save_bar"> 
					...
					<button id ="of_save" type="button" class="btn-sec"><i class="pix-icon icon-save-disk"></i> <?php esc_html_e('Save All Changes', 'composer' );?></button>			
