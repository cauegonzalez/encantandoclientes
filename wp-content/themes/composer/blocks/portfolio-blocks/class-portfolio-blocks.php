<?php
    class portfolio_blocks {
        ...
        public function filter( $show_filter = 'yes', $filter_style = 'normal', $filter_array = array(), $filter_array_order = array() ) {
        ...
        public function lightbox( $image_id = '', $img_fullsize = '', $show_lightbox = 'yes' ) {
            ...
            if( 'yes' == $show_lightbox ) { 
                ...
                $output .= '<div class="portfolio-icons">';
                    $output .= '<div class="center-wrap">';
                        $output .= '<a href="'. esc_url( $img_fullsize ) .'" class="port-icon-hover popup-gallery" data-title="'. esc_attr( get_the_title( $image_id ) ) .'"><i class="pixicon-plus"></i></a>';
