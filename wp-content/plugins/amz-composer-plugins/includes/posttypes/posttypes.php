 ...
 */
    ...
    $slug_portfolio_cat = isset($smof_data['slug_portfolio_cat']) ? esc_html(strtolower($smof_data['slug_portfolio_cat'])) : 'portfolio-category';
	...
	$por_arr = apply_filters( 'composer_pix_portfolio_post_type_args', $por_arr );
