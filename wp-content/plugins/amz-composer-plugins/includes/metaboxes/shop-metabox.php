<?php
	...
	$posts_metabox = array(
		...
		'fields'     => array(
			...
			array(
				'id'          => $amz_prefix . 'overlay_color',
				'title'       => esc_html__('Overlay Color', 'amz-composer-plugins'),
				'description' => esc_html__('It\'s only for Horizontal and vertical overlay post shortcode', 'amz-composer-plugins'),
				'std'         => '',
				'type'        => 'colorpicker'
			),
			...
			array(
				'id'           => $amz_prefix . 'shop_thumb',
				'title'        => esc_html__('Catalog Image', 'amz-composer-plugins'),
				'description'  => esc_html__('If you don\'t choose this image feature image will apply' , 'amz-composer-plugins'),
				'option'       => 'image', // image, audio, video
				'multi_select' => false, // true, false
				'type'         => 'media_manager',
			),
