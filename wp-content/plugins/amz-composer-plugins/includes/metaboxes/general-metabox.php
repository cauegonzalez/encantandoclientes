<?php
	...
	$general_metabox_active = composer_get_option_value( 'general_metabox_active', array() );
	$general_metabox_active = array_diff( $general_metabox_active, array( '0', '1' ) );
	$general_metabox_active = array_filter( $general_metabox_active );

	if( ! empty( $general_metabox_active ) ) {
		foreach( $general_metabox_active as $key => $cpt ) {

			//Preloader Animation Style
			$general_transition = array( "default" => "Default", "fadeIn" => "Fade In", "fadeInUp" => "Fade In Up", "fadeInDown" => "Fade In Down", "fadeInLeft" => "Fade In Left", "fadeInRight" => "Fade In Right", "zoomIn" => "Zoom In", "zoomInUp" => "Zoom In Up", "zoomInDown" => "Zoom In Down", "zoomInLeft" => "Zoom In Left", "zoomInRight" => "Zoom In Right");
			...
			$general_metabox = array(
				...
				'fields'     => array(
					...
					array(
						'id'           => $amz_prefix . 'demo_retina_logo',
						'title'        => esc_html__('Retina Logo', 'amz-composer-plugins'),
						'description'  => esc_html__('Choose retina logo for this page.', 'amz-composer-plugins'),
						'option'       => 'image', // image, audio, video
						'multi_select' => false, // true, false
						'type'         => 'media_manager'
					),
					...
					array(
						'id'           => $amz_prefix . 'demo_retina_light_logo',
						'title'        => esc_html__('Retina Light Logo', 'amz-composer-plugins'),
						'description'  => esc_html__('Choose retina light logo for this page.', 'amz-composer-plugins'),
						'option'       => 'image', // image, audio, video
						'multi_select' => false, // true, false
						'type'         => 'media_manager'
					),
					...
					array(
						...
						'options'	   => array(
							...
							'header-11'    => 'header-layout/header11.png',
							'left-header'  => 'header-layout/left-header.png',
							'right-header' => 'header-layout/right-header.png'
						),
						'type' 		   => 'image_select',
						'class' => 'header', // class name for this meta field
					),
					...
					array(
						...
						'options'	   => array(
							...
							'nav-border nav-border-bottom'        => 'menu/nav-border-halfline.png',
			...
			return new Amazee_Metabox( $general_metabox );
		}
	}
