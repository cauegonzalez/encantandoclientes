...
$options        = array(
    ...
    'space-project' => array(
        'title'         => __('Space Project', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/space/',
        ),
    'personal-site' => array(
        'title'         => __('Personal Site', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/personal-site/',
        ),
    'basketball-player' => array(
        'title'         => __('Basketball Player', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/basketball/',
        ),
    'fitness-2' => array(
        'title'         => __('Fitness 2', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/fitness/',
        ),
    'cupcakes-shop' => array(
        'title'         => __('Cupcakes Shop', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/cupcakes-shop/',
        ),
    'folio' => array(
        'title'         => __('Folio', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/folio/',
        ),
    ...
    'photographer-2' => array(
        ...
        'preview_url'   => 'http://innwithemes.com/composer/photographer2demo/',
        ),
