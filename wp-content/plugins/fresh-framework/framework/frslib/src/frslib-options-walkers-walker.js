...
/**********************************************************************************************************************/
		_.callbackGetBlockItem = function(){ console.log('getblock original')};

		_.callbackGetEmptyRepeatableVariation = function() {};
...
/**********************************************************************************************************************/
        ...
        _.walkContainerRepeatableVariable = function( item ) {
			...
			if( canBeEmpty && !_.isShadowPrinting ) {
				_.callbackGetEmptyRepeatableVariation();
			}
