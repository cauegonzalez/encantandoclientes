...
class ffFrameworkScriptLoader extends ffBasicObject {
	...
	public function requireFreshGrid() {
		...
		$css->addStyleFramework('ff-animate-min', $path.'extern/animate.css/animate.min.css');
		$css->addStyleFramework('ff-freshgrid', $path.'freshGrid.css');

		$js->addScriptFramework('ff-match-height', $path.'extern/matchHeight.js/jquery.matchHeight.min.js', array('jquery'));
		$js->addScriptFramework('ff-wow', $path.'extern/wow.js/wow.min.js');
		$js->addScript('ff-youtube-api', '//www.youtube.com/iframe_api');
		$js->addScriptFramework('ff-isonscreen', $path.'extern/isOnScreen.js/jquery.isOnScreen.min.js');
		$js->addScriptFramework('ff-freshgrid', $path.'jquery.freshGrid.js');
